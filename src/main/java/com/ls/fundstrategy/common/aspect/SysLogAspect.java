package com.ls.fundstrategy.common.aspect;
...
import com.ls.fundstrategy.util.CommonUtil;
import com.ls.fundstrategy.util.ThreadPoolUtil;
...
public class SysLogAspect {
    ...
    @Pointcut("@annotation(com.ls.fundstrategy.common.annotation.SysLog)")
